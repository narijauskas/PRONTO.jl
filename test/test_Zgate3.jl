...
# ------------------------------- zgate3 system to eigenstate 2 ------------------------------- ##

@kwdef struct zgate3 <: Model{12,1,4}
...
PRONTO.Pf(α,μ,tf,θ::zgate3) = SMatrix{12,12,Float64}(I(12))
...
file = matopen("Uopt_Zgate_10T.mat", "w")
write(file, "Uopt", us)
close(file)